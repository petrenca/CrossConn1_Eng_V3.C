...
PennController("demographics",
               ...
               newText("intro_instructions", "<p>This experiment investigates how people process linguistic information.<p>"
                       ...
                       .settings.css("font-size", "20px")
               ,
               newCanvas("introcanvas",1000, 300)
               ...
               .wait(getTextInput("native_languages")
                     ...
                     .failure(
                         ...
                         .success()
                         .failure(
                             newText("IDerror2","<br>Please answer the question about other languages you curently speak.")
                             .settings.color("red")
                             //.settings.center()
                             .print(1000,800)
...
//====================================================================================================================================================================================================================
// 2. Practice trials
PennController.Template( PennController.GetTable( "complex_V3.csv")// change this line for the appropriate experimental list
                         ...
                         variable => PennController( "practice_trials",
                                                     ...
                                                     .settings.add( 40, 0,newCanvas(400,10)
                                                                    .settings.add( -10,0, getText("sentence_intro")))
                                                     ...
                                                     .settings.add( "left at 0%", "middle at 50%", getImage("image_intro"))
                                                     .settings.add( "center at 50%", "middle at 50%", getImage("image_guess"))
                                                     .settings.add( "right at 100%", "middle at 50%", getImage("image_outcome") )
                                                     .center()
                                                     .print()
                                                     ,
